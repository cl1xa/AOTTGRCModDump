...
public class TypewriterEffect : MonoBehaviour
{
	...
	private void Update()
	{
		if (mLabel == null)
		{
			...
			mText = mLabel.font.WrapText(mLabel.text, (float)mLabel.lineWidth / mLabel.cachedTransform.localScale.x, mLabel.maxLineCount, encoding: false, UIFont.SymbolStyle.None);
		}
