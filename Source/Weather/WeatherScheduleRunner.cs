	...
	public void ConsumeSchedule()
	{
		...
		while (!flag)
		{
			...
			case WeatherAction.SetValue:
				SettingsUtil.SetSettingValue((BaseSetting)_manager._currentWeather.Settings[weatherEvent.Effect.ToString()], weatherEvent.GetSettingType(), weatherEvent.GetValue());
				_manager._needSync = true;
				break;
			...
			case WeatherAction.SetTargetValue:
				SettingsUtil.SetSettingValue((BaseSetting)_manager._targetWeather.Settings[weatherEvent.Effect.ToString()], weatherEvent.GetSettingType(), weatherEvent.GetValue());
				_manager._needSync = true;
				break;
			case WeatherAction.SetTargetTime:
			{
				...
				BaseSetting obj = (BaseSetting)_manager._startWeather.Settings[weatherEvent.Effect.ToString()];
