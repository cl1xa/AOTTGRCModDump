...
public class CostumeConeveter
{
	...
	public static HeroCostume LocalDataToHeroCostume(string slot)
	{
		...
		heroCostume.hairInfo = ((IntToSex(PlayerPrefs.GetInt(slot + PhotonPlayerProperty.sex)) == SEX.FEMALE) ? CostumeHair.hairsF[PlayerPrefs.GetInt(slot + PhotonPlayerProperty.hairInfo)] : CostumeHair.hairsM[PlayerPrefs.GetInt(slot + PhotonPlayerProperty.hairInfo)]);
