...
internal class IntroButton : Button
{
	...
	protected override void DoStateTransition(SelectionState state, bool instant)
	{
		...
		case SelectionState.Pressed:
			_hoverImage.CrossFadeAlpha(1f, _fadeTime, ignoreTimeScale: true);
			switch (state)
			{
			case SelectionState.Pressed:
				component.CrossFadeColor(UIManager.GetThemeColor("MainMenu", "IntroButton", "PressedColor"), _fadeTime, ignoreTimeScale: true, useAlpha: true);
				break;
			case SelectionState.Highlighted:
				component.CrossFadeColor(UIManager.GetThemeColor("MainMenu", "IntroButton", "HighlightedColor"), _fadeTime, ignoreTimeScale: true, useAlpha: true);
				break;
			}
			break;
		case SelectionState.Normal:
			_hoverImage.CrossFadeAlpha(0f, _fadeTime, ignoreTimeScale: true);
			component.CrossFadeColor(UIManager.GetThemeColor("MainMenu", "IntroButton", "NormalColor"), _fadeTime, ignoreTimeScale: true, useAlpha: true);
			break;
		}
	}
}
