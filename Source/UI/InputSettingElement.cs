...
internal class InputSettingElement : BaseSettingElement
{
	...
	private IEnumerator WaitAndFinishSetup()
	{
		...
		base.Setup((BaseSetting)_setupParams[0], (ElementStyle)_setupParams[1], (string)_setupParams[2], (string)_setupParams[2]);
		StartCoroutine(WaitAndFixInputField());
		_finishedSetup = true;
	}
	...
	private void Update()
	{
		if (!_caret && _inputField != null)
		{
			...
			if ((bool)_caret && !_caret.GetComponent<Graphic>())
			{
