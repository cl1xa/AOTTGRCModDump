	...
	public void doAction()
	{
		...
		case 1:
		{
			...
			case 12:
				if (!FengGameManagerMKII.intVariables.ContainsKey(text4))
				{
					FengGameManagerMKII.intVariables.Add(text4, UnityEngine.Random.Range(num2, parameters[2].returnInt(null)));
				}
				else
				{
					FengGameManagerMKII.intVariables[text4] = UnityEngine.Random.Range(num2, parameters[2].returnInt(null));
				}
				break;
			case 7:
			case 8:
		...
		case 2:
		{
			string text3 = parameters[0].returnString(null);
			...
			case 11:
				...
				{
					callException("Variable not found: " + text3);
				}
				else
				{
		...
		case 3:
		{
			...
			case 9:
				parameters[1].returnString(null);
				if (!FengGameManagerMKII.stringVariables.ContainsKey(key3))
				{
					callException("No Variable");
				}
		...
		case 7:
		{
			...
			case 0:
			{
				...
				{
					HERO obj = (HERO)FengGameManagerMKII.heroHash[iD2];
					obj.markDie();
					obj.photonView.RPC("netDie2", PhotonTargets.All, -1, parameters[1].returnString(null) + " ");
				}
				else
				{
			...
			case 3:
			{
				...
				{
					((HERO)FengGameManagerMKII.heroHash[iD]).photonView.RPC("moveToRPC", photonPlayer, parameters[1].returnFloat(null), parameters[2].returnFloat(null), parameters[3].returnFloat(null));
				}
				else
				{
					callException("Player Not Alive");
