...
internal class QuestHandler : BaseGameProgressHandler
{
	...
	private void LoadQuests()
	{
		...
		listSetting.Value.AddRange(CreateQuests(questContainer, days, daily: true, 3 - listSetting.Value.Count));
		...
		listSetting2.Value.AddRange(CreateQuests(questContainer, days, daily: false, 3 - listSetting2.Value.Count));
